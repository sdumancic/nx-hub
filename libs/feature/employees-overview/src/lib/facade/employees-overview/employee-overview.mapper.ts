...
import {
  EMPLOYEE_ADDRESS_CITY, EMPLOYEE_ADDRESS_STATE,
  EMPLOYEE_ADDRESS_STREET, EMPLOYEE_ADDRESS_ZIP, EMPLOYEE_DEPARTMENT,
  EMPLOYEE_DOB, EMPLOYEE_EMAIL, EMPLOYEE_GENDER, EMPLOYEE_HIRED_ON,
  EMPLOYEE_NAME_FIRST, EMPLOYEE_NAME_LAST, EMPLOYEE_SSN, EMPLOYEE_TERMINATED_ON,
  EMPLOYEE_USERNAME,
...
import {
  EmployeeOverviewSearchUi, FILTER_KEY_REMOVABLE,
  FILTER_KEY_TRANSLATION, FILTER_KEY_VALUE_TYPE
...
export class EmployeeOverviewMapper {
  ...
  static fromEmployeeOverviewSearchUi (
    ...
    return {
      ...
      ssn: null,
      dobFrom: searchValues.dobFrom,
      dobUntil: searchValues.dobUntil,
      hiredOnFrom: moment(searchValues.hiredOnFrom).utc(true)
        .startOf('day')
        .toISOString(),
      hiredOnUntil: moment(searchValues.hiredOnUntil).utc(true)
        .endOf('day')
        .toISOString(),
      terminatedOnFrom: moment(searchValues.terminatedOnFrom).utc(true)
        .startOf('day')
        .toISOString(),
      terminatedOnUntil: moment(searchValues.terminatedOnUntil).utc(true)
        .endOf('day')
        .toISOString(),
  ...
  static queryParamsToSearchUi (
    ...
    return {
      ...
      dobFrom: queryParams.dobFrom != null
        ? moment(queryParams.dobFrom, 'DD-MM-YYYY')
          .utc(true)
          .toISOString()
        : null,
      dobUntil: queryParams.dobUntil != null
        ? moment(queryParams.dobUntil, 'DD-MM-YYYY')
          .utc(true)
          .toISOString()
        : null,
      hiredOnFrom: queryParams.hiredOnFrom != null
        ? moment(queryParams.hiredOnFrom, 'DD-MM-YYYY')
          .utc(true)
          .toISOString()
        : null,
      hiredOnUntil: queryParams.hiredOnUntil != null
        ? moment(queryParams.hiredOnUntil, 'DD-MM-YYYY')
          .utc(true)
          .toISOString()
        : null,
      terminatedOnFrom: queryParams.terminatedOnFrom != null
        ? moment(queryParams.terminatedOnFrom, 'DD-MM-YYYY')
          .utc(true)
          .toISOString()
        : null,
      terminatedOnUntil: queryParams.terminatedOnUntil != null
      ...
      department: queryParams.department != null ? queryParams.department.split(',') : null,
