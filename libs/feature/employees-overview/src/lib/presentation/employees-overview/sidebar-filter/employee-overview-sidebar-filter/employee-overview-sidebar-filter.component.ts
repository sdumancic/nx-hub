...
} from "../../filter-chips/employee-overview-filter-chips/employee-overview-filter-chips.component";
import {
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatButtonModule, MatDatepickerModule, MatDividerModule, MatFormFieldModule, MatIconModule, MatInputModule, MatOptionModule, MatSelectModule,
    EmployeeOverviewFilterChipsComponent, EmployeeOverviewFilterCounterComponent, ReactiveFormsModule],
  templateUrl: "./employee-overview-sidebar-filter.component.html",
  styleUrls: ["./employee-overview-sidebar-filter.component.scss"]
})
export class EmployeeOverviewSidebarFilterComponent implements OnInit, OnDestroy {
